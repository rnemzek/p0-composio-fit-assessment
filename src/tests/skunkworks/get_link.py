...
try:
    ...
    connection = client.connected_accounts.initiate(
        "gmail",
        entity_id=os.getenv("COMPOSIO_USER_ID")                      # pg-test-fb03294d-998b-4fbd-8143-ab9f142e7003
    )
    ...
    try:
        ...
        ts = ComposioToolSet(api_key=os.getenv("COMPOSIO_API_KEY"))  # ak_NguOTc4AwH4s0Qu_KUQ7
        # In some 0.11.1 sub-versions, it's back to 'app_name'
        conn = ts.connected_accounts.initiate(app_name="gmail", entity_id=os.getenv("COMPOSIO_USER_ID")   # pg-test-fb03294d-998b-4fbd-8143-ab9f142e7003
